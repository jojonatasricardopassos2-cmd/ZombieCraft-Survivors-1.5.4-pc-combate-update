...
export const CRAFTING_RECIPES: { [itemId: string]: { [resourceId: string]: number } } = {
    ...
    'pickaxe_wood': { 'wood': 2, 'refined_wood': 10 },
    'pickaxe_stone': { 'wood': 2, 'stone': 10 },
    'pickaxe_iron': { 'wood': 2, 'iron_ingot': 10 },
    'pickaxe_gold': { 'wood': 2, 'gold_ingot': 10 },
    'pickaxe_diamond': { 'wood': 2, 'diamond': 10 },

    'axe_wood': { 'wood': 2, 'refined_wood': 10 },
    'axe_stone': { 'wood': 2, 'stone': 10 },
    'axe_iron': { 'wood': 2, 'iron_ingot': 10 },
    'axe_gold': { 'wood': 2, 'gold_ingot': 10 },
    'axe_diamond': { 'wood': 2, 'diamond': 10 },
    'axe_ruby': { 'wood': 2, 'ruby': 15 },
    
    'sword_wood': { 'wood': 2, 'refined_wood': 10 },
    'sword_stone': { 'wood': 2, 'stone': 10 },
    'sword_iron': { 'wood': 2, 'iron_ingot': 10 },
    'sword_gold': { 'wood': 2, 'gold_ingot': 10 },
    'sword_diamond': { 'wood': 2, 'diamond': 10 },
    'sword_ruby': { 'wood': 2, 'ruby': 15 },
